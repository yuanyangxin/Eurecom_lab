...
public class QueryCheck {
  ...
  public QueryCheck(int q_index) {
    ...
    Q7result.addElement(new S2("Tom Reps"));
    Q7result.addElement(new S2("Jeff Naughton"));
    Q7result.addElement(new S2("Miron Livny"));
    Q7result.addElement(new S2("Marv Solomon"));
    Q7result.addElement(new S2("Anne Condon"));
    Q7result.addElement(new S2("Charles Fischer"));
    Q7result.addElement(new S2("James Goodman"));
    Q7result.addElement(new S2("Mark Hill"));
    Q7result.addElement(new S2("Bob Holloway"));
    Q7result.addElement(new S2("Yannis Ioannidis"));
    Q7result.addElement(new S2("Deborah Joseph"));
    Q7result.addElement(new S2("Landwebber"));
    Q7result.addElement(new S2("James Larus"));
    Q7result.addElement(new S2("Barton Miller"));
    Q7result.addElement(new S2("Raghu Ramakrishnan"));
    Q7result.addElement(new S2("Guri Sohi"));
    Q7result.addElement(new S2("Prasoon Tiwari"));
    Q7result.addElement(new S2("Mary Vernon"));
    Q7result.addElement(new S2("David Wood"));
    Q7result.addElement(new S2("Mark Smucker"));
    Q7result.addElement(new S2("Martin Reames"));
